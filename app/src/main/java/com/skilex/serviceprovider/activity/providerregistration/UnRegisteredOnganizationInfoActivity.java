...
public class UnRegisteredOnganizationInfoActivity extends BaseActivity implements View.OnClickListener, IServiceListener,
        DialogClickListener {

    private static final String TAG = UnRegisteredOnganizationInfoActivity.class.getName();
    ...
    public void onResponse(JSONObject response) {
        ...
        if (validateSignInResponse(response)) {
            ...
            Intent i = new Intent(UnRegisteredOnganizationInfoActivity.this, UnRegOrgDocumentUploadActivity.class);
            startActivity(i);
